...
<?php   } ?>
    <div id="page_bar">
<?php   if (mc_has_new()) { ?>
      <span class="prev" style="float:left;"><?php mc_goto_new('&larr;上一页'); ?></span>
<?php   } ?>
<?php   if (mc_has_old()) { ?>
      <span class="next" style="float:right;"><?php mc_goto_old('下一页&rarr;'); ?></span>
<?php   } ?>
      <div class="clearer"></div>
    </div>
    <div class="clearer"></div>
  ...
  <div id="side">
    <div id="navbar">
      <ul>
        ...
        <li><a href="<?php mc_site_link(); ?>/?link/">友链</a></li>
